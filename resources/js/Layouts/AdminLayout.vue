...
<template>
    <div class="flex h-screen overflow-hidden bg-slate-100 dark:bg-slate-950">
        ...
        <aside
            class="fixed inset-y-0 left-0 z-50 flex h-screen shrink-0 flex-col border-r border-slate-200 bg-slate-900 transition-all duration-200 dark:border-slate-800 lg:static lg:translate-x-0"
            :class="[
        ...
        <div class="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            <header class="z-30 flex h-14 shrink-0 items-center gap-4 border-b border-slate-200 bg-white px-4 dark:border-slate-800 dark:bg-slate-900 lg:px-6">
