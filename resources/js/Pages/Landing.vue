...
const zigzagFeatures = [
    ...
    },
    {
        ...
        description: 'A beautiful dashboard with live visitor counts, daily trends, top pages, referrer breakdowns, and goal-based conversion tracking — everything you need to understand your traffic at a glance.',
